    ...
    <body>
        <div class="ndesign" id="cssall">
            <div class="ndesign" id="ncenter">
                <div class="ndesign" id="center_pic"><a href="web_images/kunooz.gif" rel="lightbox" title="Kunooz Logo"><img src="web_images/kunooz.gif" width="196" height="197"></a></div>
                <div class="ndesign" id="line">
                    <div align="center"><span class="style1">Select a Picture </span></div>
                </div>
                <p>&nbsp;</p>
                <p>Handcrafted  Moroccan products and decor<strong></strong></p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p align="center"><a href="web_images/kunooz1.gif" rel="lightbox" title="Kunooz Watches"><img src="web_images/kunooz1.gif" width="150" height="150"></a> <a href="web_images/kunooz2.gif" rel="lightbox" title="Kunooz Products"><img src="web_images/kunooz2.gif" width="150" height="150"></a></p>
            </div>
            <div class="ndesign" id="nlocation">
                <div align="center">
                    <p>&nbsp;</p>
                    <p><img src="location gif/Kunooz.gif" width="295" height="100"></p>
                </div>
            </div>
