    ...
    <body onload="setTimeout('redirect()',5000)">
        <div class="ndesign" id="cssall">
            ...
            <div class="ndesign" id="ncenter" align="center">
                ...
                <font face="Times New Roman, Times, serif"><h1><em><strong> 
                    <p>&nbsp;</p>
                    <p>Thank you for registration in Daffodils Palace Hotel</p>
                    <p>You can now reserve rooms that will satisfy your needs </p>
                </strong></em></h1></font><br>
                if your were not redirected automaticaly to the Home page in 5 seconds <br> <a href="home.jsp" style="color:blue"><u><u>CLICK HERE</u></u></a>
