    ...
    <body>
        <div class="ndesign" id="cssall">
            ...
            <div class="ndesign" id="ncenter">
                ...
                <form id="form1" name="form1" method="post" action="reservation.page" onSubmit="return defaultagree(this)">
                    ...
                    <table width="475" height="559" border="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea cols="40" rows="6" readonly="true">
Please Note than:
                                    
- Confirmation will save the reservation from being cancelled.  

- If you confirmed your reservation be careful that the system will use the credit card number to withdraw the room price before the arrival date by three days. 

- Otherwise the reservation will be cancelled and the room price will be withdrawn also. 

- When the customer reserved and put his personal credit card number he has to make sure that he has cancelled the reservation when he changed his mined or confirmed it before three days of the arrival date in the otherwise.                               
                                </textarea>
                                <br><input name="agreecheck" type="checkbox" onClick="agreesubmit(this)"><b>I agree to the above terms</b>                                
                            </td>
                ...
                <script language="JavaScript">
                    document.forms.form1.agreecheck.checked=false
                </script>
