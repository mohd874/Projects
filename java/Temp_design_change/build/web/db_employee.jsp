    ...
    <body>
        <div class="ndesign" id="cssall2">
            ...
            <div class="ndesign" id="nmiddlebar">
                ...
                <form name="form1" method="post" action="db_employee.jsp">
                   
                    <table width="500" border="0">
                        <tr>
                            <th colspan="5" scope="col">Employee Database Panel</th>
                        </tr>
                        <tr>
                ...
                <form name="form2" method="post" action="db_action_control_emp.page">
                    <table width="1799">
                        <tr>
                            <td width="43">
                            Select                                </td>
                        ...
                        <c:forEach var="record" items="${selection.rows}" >
                            <tr>
                                ...
                                ${record.gender}                                </td>
                                <td>
                                ${record.marital_status}                                </td>
                                <td>
                                ${record.years_of_exp}                                </td>
                                <td>
                                ${record.service_no}                                </td>
